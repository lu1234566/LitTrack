  ...
  return (
    <Screen>
      <View style={styles.hero}>
        ...
        <Text style={styles.title}>Seu diário literário, agora em app nativo.</Text>
        <Text style={styles.subtitle}>Base inicial da migração Expo/React Native, sem afetar o projeto web original.</Text>
      </View>
